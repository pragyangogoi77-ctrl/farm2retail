...
export class Backend implements backendInterface {
    ...
    async getFarmById(arg0: bigint): Promise<Farm> {
        if (this.processError) {
            try {
    ...
    async getProductsByFarmId(arg0: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByFarmId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
